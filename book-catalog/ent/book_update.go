...
func (bu *BookUpdate) SetNillablePublicationDate(s *string) *BookUpdate {
	if s != nil {
		bu.SetPublicationDate(*s)
	}
	return bu
}
...
// SetNillablePublicationDate sets the "publication_date" field if the given value is not nil.
func (buo *BookUpdateOne) SetNillablePublicationDate(s *string) *BookUpdateOne {
	if s != nil {
		buo.SetPublicationDate(*s)
	}
	return buo
}
